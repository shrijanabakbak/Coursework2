...
public class View {
    ...
    View(){
        ...
        JFrame f=new JFrame("Bookstore Management System");
        ...
        btnUpdate.addActionListener(e->{
            ...
            if(row>=0) {
                ...
                btnChange.addActionListener(e3->{
                    ...
                    String uquery ="update `bookies` set `BookName` = '" + tbName + "',`PublisherName` = '" + taName + "', `Field` = '" + taddBy + "',  `Date` = '"+ tpDate +"' WHERE `BookCode` = '"+ Code +"'";
                    String squery ="update `sold` set `BookName` = '" + tbName + "',`PublisherName` = '" + taName + "', `Field` = '" + taddBy + "',  `Date` = '"+ tpDate +"' WHERE `BookName` = '"+ BookName1 +"'";
...
//		        	System.out.println(se.binarySearch(Quan, bookNumber));
        ...
        f.add(btnSell);
        btnSell.setBounds(50, 450, 100, 30);
